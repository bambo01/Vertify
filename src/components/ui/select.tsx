...
>(({ className, children, ...props }, ref) => (
  <SelectPrimitive.Trigger
    ref={ref}
    className={cn(
      "flex h-9 w-full items-center justify-between outline-none focus:outline-none rounded-md border border-input bg-background px-3 py-2 text-sm dark:bg-[#1e1e1e] dark:text-white border-gray-600",
